...
1. Run **test scripts** in command line.
1. You should **not** see the number(s) of skipped, passing and failing tests.
...
#### Notes
1. We recommend you to use Node.js of version 22.x.x LTS. If you use any of features, that does not supported by Node.js 22, there may be problems with task submit.
...
© Task creator [AlreadyBored](https://github.com/AlreadyBored)
